...
func set_price_label():
	...
	if GameManager.gems - price < 0:
		price_label.label_settings.set_font_color(Color.html("#d95763")) #RED
		self.disabled = true
	else:
		price_label.label_settings.set_font_color(Color.html("#232323")) #WHITE

func set_visibility(boolean : bool):
